...
#TestDataset = builds(datasets.MNISTC,root=DATA_DIR,train=False,transform=ToTensor)
#TestDataset = MNISTC(root=DATA_DIR,corruption='spatter',grouping='test',download=True)
#corrs = MNISTC.all_corruptions
TestDataset = builds(MNISTC,root=DATA_DIR,corruptions='spatter',grouping='test',transform=ToTensor)
